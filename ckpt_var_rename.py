...
### using this script when the quantization model export has variable name error ###
usage_str = 'python ckpt_var_rename.py --checkpoint_dir=path/to/dir/ ' \
            '--replace_from=conv_quant --replace_to=act_quant --add_prefix=abc --dry_run'
...
def rename(checkpoint_dir, replace_from, replace_to, add_prefix, dry_run):
    ...
    with tf.Session() as sess:
        ...
        if not dry_run:
            ...
            print('Checkpoint save to %s.' % (checkpoint_dir))
