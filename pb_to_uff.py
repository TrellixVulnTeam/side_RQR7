...
class ModelData(object):
    ...
    # OUTPUT_NAME = 'conv2d_17/BiasAdd','conv2d_20/BiasAdd','conv2d_23/BiasAdd'
    OUTPUT_NAME = 'header/map/TensorArrayStack/TensorArrayGatherV3','header/map/TensorArrayStack_1/TensorArrayGatherV3','header/map/TensorArrayStack_2/TensorArrayGatherV3'
...
MODEL_PATH = os.path.join('tiny_3l_50000_None.pb')
